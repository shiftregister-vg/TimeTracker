...
class ProjectController {
    ...
    def save = {
        ...
        if (projectInstance.save(flush: true)) {
            ...
            redirect(action: "show", params:[projectID: projectInstance.projectID])
        }
        else {
    ...
    def delete = {
        ...
        if (projectInstance) {
            try {
                ...
                flash.message = "${message(code: 'default.deleted.message', args: [message(code: 'project.label', default: 'Project'), params.projectID])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${message(code: 'default.not.deleted.message', args: [message(code: 'project.label', default: 'Project'), params.projectID])}"
                redirect(action: "show", projectID: params.projectID)
            }
        }
        else {
            flash.message = "${message(code: 'default.not.found.message', args: [message(code: 'project.label', default: 'Project'), params.projectID])}"
